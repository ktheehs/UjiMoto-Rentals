...
public class RentalTest
{
   public static void main(String[] args)
   {
      ...
      for(x = 0; x < rentals.length; ++x)
      {
         ...
         minutes = getMinutes();
         equipType = getType();
         rentals[x] = new LessonWithRental(contractNum, minutes, equipType);
         rentals[x].setContactPhone(getPhone());
         rentals[x].setEquipType(equipType);
      }
   ...
   public static void sortByContractNumber(Rental[] array)
   {
      ...
      {
         displayDetails((LessonWithRental) array[a]);
      }
   }
   public static void sortByPrice(LessonWithRental[] rentals)
   {
       int a,b;
       LessonWithRental temp;
       int highSubscript = rentals.length  - 1;
   ...
   public static void displayMotto()
   {
      ...
      System.out.println("S  Uji Moto makes it fun in the sun. S");
      System.out.println("S                                    S");
      System.out.println("SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS");
   }
